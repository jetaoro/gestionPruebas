...
public class Prueba {
    ...
    public String getPrueba(int idPrueba){
        ...
        tabla += "\n<tr>"; 
        tabla += "\n<div class=\"formRow\"><h4 class='t_center'>Registro de Ejecución de Pruebas</h4></div>";
        tabla += "<div class=\"formRow\"><label></label>" + "\n<div class='formRight'>" + "<input style='width: 40%;' type='hidden' name='idPrueba' readonly='readonly' value='" + prueba.getIdentificador() + "'></div></div>";
        tabla += "\n<div class=\"formRow\"><label>Número de requerimiento</label>" + "\n<div class='formRight'>" + "<input style='width: 40%;' type='text' name='numero_requerimiento' readonly='readonly' value='" + prueba.getNumero_requerimiento() + "'></div></div>";
        tabla += "\n<div class=\"formRow\"><label>Nombre</label>" + "\n<div class=\"formRight\">" + "<textarea style='width: 40%;' name='nombre' readonly='readonly' >"+prueba.getNombre()+"</textarea></div></div>";
        tabla += "\n<div class=\"formRow\"><label>Fecha Ejecuci&oacute;n</label>" + "\n<div class=\"formRight\">" + "<input style='width: 40%;'type='text' name='fecha_ejecucion' readonly='readonly' value='" + df1.format(prueba.getFecha_ejecucion()) + "'></div></div>";
        tabla += "\n<div class=\"formRow\"><label>Elemento a probar</label>" + "\n<div class=\"formRight\">" + "<input style='width: 40%;' type='text' name='elemento_prueba' readonly='readonly' value='" + prueba.getElemento_prueba() + "'></div></div>";
        tabla += "\n<div class=\"formRow\"><label>Tipo de Prueba</label>" + "\n<div class=\"formRight\">" + "<input style='width: 40%;' type='text' name='tipo_prueba' readonly='readonly' value='" + prueba.getTipoPrueba().getDescripcion() + "'></div></div>";
        tabla += "\n<div class=\"formRow\"><label>Modos de Ejecución</label>" + "\n<div class=\"formRight\">" + "<input style='width: 40%;' type='text' name='modo_ejecucion' readonly='readonly' value='" + prueba.getNombreModosEjecucion() + "'></div></div>";
        tabla += "\n<div class=\"formRow\"><label>Descripción de la Prueba</label>" + "\n<div class=\"formRight\">" + "<textarea style='width: 40%;' type='text' name='descripcion' readonly='readonly' >" + prueba.getDescripcion() + "</textarea></div></div>";
        tabla += "\n<div class=\"formRow\"><label>Caso de éxito</label>" + "\n<div class=\"formRight\">" + "<textarea style='width: 40%;'type='text' name='caso_exito' readonly='readonly' >" + prueba.getCaso_exito() + "</textarea></div></div>";
        tabla += "\n<div class=\"formRow\"><label>Caso de Fallo</label>" + "\n<div class=\"formRight\">" + "<textarea style='width: 40%;'type='text' name='caso_fallo' readonly='readonly' >" + prueba.getCaso_fallo() + "</textarea></div></div>";        
        tabla+="\n<div class=\"formRow\"><h4 class='t_center'>Casos de Prueba"+"</h4></div>";
        tabla+= new CasoPrueba().getCasosPrueba(prueba);
        tabla += "\n</tr></table></br>";
    ...
    public String buscarPrueba(){
        ...
        tabla+="<label>Módulo: </label>"+"<div class=\"formRight\">"+ new Modulo().listadoModulos2()+"</div>";
        tabla+="</div>";
        tabla+="<div class=\"formRow\">";
        tabla+="<label>Responsable: </label>"+"<div class=\"formRight\">"+new Responsable().listadoResponsables2() +"</div>";
        tabla+="</div>";
        tabla+="<div class=\"formRow\">";
        tabla+="<label>Sitio Prueba: </label>"+"<div class=\"formRight\">"+"<td>"+new SitioPrueba().listadoSitiosPrueba2()+"</div>";
        tabla+="</div>";
        tabla+="</br></br></br>";
        return tabla;
    }
    ...
    public String agregarPruebaFormulario(){
        ...
        tabla+="</br>"+"Fecha de Ejecución: " + "<input id='dp6' type='text' data-date-format=\"dd/mm/yyyy\" size='30' maxlength='30' name='fecha_ejecucion' required></br>";
        tabla+="</br>"+"Pruebas realizadas por: " + new Responsable().listadoResponsables();
        tabla+="</br></br>"+"<h4>REGISTRO DE EJECUCIÓN DE PRUEBA</h4>";
        tabla+="<div class=\"formRow\">";
        tabla+="<strong>Descripción de las pruebas</strong>"; 
        tabla+="</div>";
        tabla+="<div class='formRow'>";
        tabla+="<label>Nombre de la prueba: </label>" + "<div class='formRight'> <textarea style='width: 40%;' rows='4' cols='40' name='nombre' required></textarea></div></div>";
        tabla+="<div class='formRow'> <label>Número de requerimiento: </label>" + "<div class='formRight'><input style='width: 40%;' type='text' size='40' maxlength='40' name='numero_requerimiento' required></div></div>";
        tabla+="<div class='formRow'><label>Elemento a probar: </label>" + "<div class='formRight'><input style='width: 40%;' type='text' size='40' maxlength='40' name='elemento_prueba' required></div></div>";
        ...
        tabla+="<div class='formRow'><label>Descripción de la prueba: </label>" + "<div class='formRight'><textarea style='width: 40%;' rows='4' cols='40' name='descripcion' required></textarea></div></div>";
        tabla+="<div class='formRow'><label>Caso de Éxito: </label>" + "<div class='formRight'><textarea style='width: 40%;' rows='4' cols='40' name='caso_exito' required></textarea></div></div>";
        tabla+="<div class='formRow'><label>Caso de Fallo: </label>" + "<div class='formRight'><textarea style='width: 40%;'rows='4' cols='40' name='caso_fallo' required></textarea></div></div>";
