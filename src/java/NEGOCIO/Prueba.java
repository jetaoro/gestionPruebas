...
public class Prueba {
    ...
    public String agregarPruebaFormulario(){
        ...
        tabla+="<div class='formRow'> <label>Número de requerimiento: </label>" + "<div class='formRight'><input style='width: 40%;' type='text' size='30' maxlength='30' name='numero_requerimiento' required></div></div>";
        tabla+="<div class='formRow'><label>Elemento a probar: </label>" + "<div class='formRight'><input style='width: 40%;' type='text' size='30' maxlength='30' name='elemento_prueba' required></div></div>";
