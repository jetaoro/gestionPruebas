...
public class Prueba {
    ...
    public String getPrueba(int idPrueba){
        ...
        tabla += "<div class=\"formRow\"><label></label>" + "\n<div class='formRight'>" + "<input type='hidden' name='idPrueba' readonly='readonly' value='" + prueba.getIdentificador() + "'></div></div>";
        ...
        tabla += "\n<div class=\"formRow\"><label>Nombre</label>" + "\n<div class=\"formRight\">" + "<textarea name='nombre' readonly='readonly' >"+prueba.getNombre()+"</textarea></div></div>";
        ...
        tabla += "\n<div class=\"formRow\"><label>Modos de Ejecución</label>" + "\n<div class=\"formRight\">" + "<input type='text' name='modo_ejecucion' readonly='readonly' value='" + prueba.getNombreModosEjecucion() + "'></div></div>";
        tabla += "\n<div class=\"formRow\"><label>Descripción de la Prueba</label>" + "\n<div class=\"formRight\">" + "<textarea type='text' name='descripcion' readonly='readonly' >" + prueba.getDescripcion() + "</textarea></div></div>";
        tabla += "\n<div class=\"formRow\"><label>Caso de éxito</label>" + "\n<div class=\"formRight\">" + "<textarea type='text' name='caso_exito' readonly='readonly' >" + prueba.getCaso_exito() + "</textarea></div></div>";
        tabla += "\n<div class=\"formRow\"><label>Caso de Fallo</label>" + "\n<div class=\"formRight\">" + "<textarea type='text' name='caso_fallo' readonly='readonly' >" + prueba.getCaso_fallo() + "</textarea></div></div>";        
