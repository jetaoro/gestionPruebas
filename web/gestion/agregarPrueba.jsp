               ...
               <div class="grid-title">
                ...
                <div class="pull-right"> 
                   <div class="icon-title"><a class="popover-left"  
                       title="Ayuda Agregar Pruebas" data-content="Esta página permite crear nuevas pruebas. 
                       Se debe diligenciar la información necesaria para la inserción de la prueba y presionar
                       el botón Registrar">
